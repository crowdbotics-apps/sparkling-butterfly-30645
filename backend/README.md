...
## Project Structure
    ...
    ├── sparkling_butterfly_30645  # Django project configurations
...
1. Clone this repo and `cd sparkling_butterfly_30645`
...
2. Clone this repo and `cd sparkling_butterfly_30645`
